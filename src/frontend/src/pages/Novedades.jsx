...
const VERSIONS = [
  {
    version: "0.4.3",
    date:    "5 marzo 2026",
    title:   "Envíos de email, inspector BD y herramientas admin",
    summary: "Configuración de email con Mailjet/Acumbamail, firma HTML, plantillas y envío de prueba. Inspector de base de datos con esquema y contenidos. Campos grandes ocultos por defecto.",
    tags:    ["Email config", "Plantillas", "DB Inspector", "Migración 018"],
    items: [
      "Página Envíos de email: proveedor (Mailjet/Acumbamail), API keys masked, remitente y reply-to",
      "Firma HTML común con editor rich text (negrita, cursiva, listas, links, colores)",
      "CRUD de plantillas de email con editor visual y variable {{firma}}",
      "Envío de prueba: selecciona plantilla y destinatario, envía con sustitución de firma",
      "Inspector de BD: esquema y contenidos de todas las tablas con selector dropdown",
      "Campos grandes ocultos en tabla, visibles al hacer clic en la fila (detalle completo)",
      "Migración 018 — tablas email_config y email_templates",
    ],
  },
  {
    version: "0.4.2",
    ...
    summary: "Sistema de solicitudes completo con persistencia en BD. Fix SAML y script de sincronización multi-equipo.",
    tags:    ["Solicitudes API", "Fix SAML", "Migración 017"],
    items: [
      "Backend completo de solicitudes: modelo, CRUD, 4 endpoints REST",
      "Drawer y página conectados al API real con cambio de estado y comentarios",
      "Fix SAML: user_id en JWT era email en vez de ID numérico",
